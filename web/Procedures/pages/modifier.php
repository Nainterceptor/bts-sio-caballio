...
$tools = new tools();
if (isset($_POST['Nnom'])) {
    $tools->modifier($_POST['Nnom'], $_POST['Nage'], $_POST['Ncouleur'], $_POST['Npouvoir']);
    ?>
...
<form method="post">
    ...
    <label for="Npouvoir">Et le POUVOIR ! : </label><input type="text" name="Npouvoir" value="pouvoir" /><br />
